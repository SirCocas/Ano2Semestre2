...
public class Execute extends CalculatorBaseVisitor<String> {
   ...
   @Override
   public String visitExprPositive(CalculatorParser.ExprPositiveContext ctx) {
   ...
   @Override
   public String visitExprNegative(CalculatorParser.ExprNegativeContext ctx) {
      return visit(ctx.expr()) + " !-";
   }
   ...
   @Override
   public String visitExprVariable(CalculatorParser.ExprVariableContext ctx) {
